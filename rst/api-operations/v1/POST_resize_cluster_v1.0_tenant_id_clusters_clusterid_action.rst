...
`Request <POST_resize_cluster_v1.0_tenant_id_clusters_clusterid_action.rst#request>`__
`Response <POST_resize_cluster_v1.0_tenant_id_clusters_clusterid_action.rst#response>`__
