...
`Request <DELETE_delete_a_script_v2_tenant_id_scripts_scriptid_.rst#request>`__
`Response <DELETE_delete_a_script_v2_tenant_id_scripts_scriptid_.rst#response>`__
