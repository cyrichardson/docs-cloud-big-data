...
`Request <GET_show_cluster_details_v2_tenant_id_clusters_clusterid_.rst#request>`__
`Response <GET_show_cluster_details_v2_tenant_id_clusters_clusterid_.rst#response>`__
