...
Use the Nodes API operations to retrieve the list of nodes for a specified
cluster.

.. include:: methods/get-list-cluster-nodes-v2-tenant-id-clusters-clusterid-nodes.rst
