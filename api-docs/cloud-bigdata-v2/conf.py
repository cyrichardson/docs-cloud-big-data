...
rst_epilog = """
.. |service| replace:: Cloud Big Data
...
html_title = 'Rackspace Cloud Big Data v2 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Rackspace Cloud Big Data v2 API'
...
htmlhelp_basename = 'docs-cloud-BigData'
...
latex_documents = [
  (master_doc, 'docs-cloud-big-data.tex',
   'Rackspace Cloud Big data API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
    (master_doc, 'Rackspace Cloud Big Data API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-big-data',
  'Rackspace Cloud Big Data API Documentation',
   'Rackspace', 'docs-cloud-big-data', 'Learn about using Cloud Big Data',
   'Miscellaneous'),
]
